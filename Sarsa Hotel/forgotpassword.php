<?php
   ...
   function sendMail($email,$reset_token)
   {
      ...
      try {
        ...
        $mail->Username   = 'hotelsarsa@gmail.com';                     //SMTP username
        $mail->Password   = 'kxoi jnqs ndlf ysmc';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
        //Recipients
        $mail->setFrom('hotelsarsa@gmail.com', 'sarsa hotel');
        ...
        $mail->Subject = 'Password Reset Link from sarsa hotel';
        $mail->Body    = "We got a request from you to reset password! <br>
        Click The link Below:  <br>
        <a href='http://localhost:81/Dummy/updatepassword.php?email=$email&reset_token=$reset_token'>Reset Password</a>";
